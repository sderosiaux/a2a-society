...
def build_system_prompt(
    ...
    lines.append("2. If you need a skill you don't have, identify which skill is needed")
    lines.append("3. If the decision is above your scope, escalate to your superior")
    lines.append("4. When you delegate, specify clearly what you need")
    lines.append("5. When all subtasks complete, synthesize and respond")

    # Delegation instructions
    lines.append("")
    lines.append("When you need to delegate work to a specialist, include this JSON block in your response:")
    lines.append('{"delegate": {"skill": "<skill_id>", "message": "<what you need them to do>"}}')
    ...
    if config.tools_exclusive:
        lines.append(f"Tools you do NOT have (delegate to specialists): {', '.join(config.tools_exclusive)}")
